...
namespace unityHomesApi.Migrations
{
    ...
    [Migration("20240305201417_articles")]
            ...
            modelBuilder.Entity("HomesApi.Models.Property", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            City = "City 1",
                            DateAdded = new DateTimeOffset(new DateTime(2024, 3, 5, 20, 14, 17, 372, DateTimeKind.Unspecified).AddTicks(230), new TimeSpan(0, 0, 0, 0, 0)),
                            DateUpdated = new DateTimeOffset(new DateTime(2024, 3, 5, 20, 14, 17, 372, DateTimeKind.Unspecified).AddTicks(230), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 3L,
                            City = "City 3",
                            DateAdded = new DateTimeOffset(new DateTime(2024, 3, 5, 20, 14, 17, 372, DateTimeKind.Unspecified).AddTicks(240), new TimeSpan(0, 0, 0, 0, 0)),
                            DateUpdated = new DateTimeOffset(new DateTime(2024, 3, 5, 20, 14, 17, 372, DateTimeKind.Unspecified).AddTicks(240), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "A nice little cottage in the countryside.",
                            HasGarden = true,
                            IsAvailable = false,
                            MonthlyRent = 600,
